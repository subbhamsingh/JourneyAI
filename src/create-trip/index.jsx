...
function CreateTrip() {
  ...
  const OnGenerateTrip = async() => {
   ...
   .replace('{budeget}',formData?.budget)
   .replace('{totalDays}',formData?.noOfDays)
  ...
  return (
    <div className="sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10">
      ...
      <p className="mt-3 text-gray-500 text-xl">
        Provide some basic information, and our trip planner will generate a customized itinerary based on your preferences. 🏕️🌴
      </p>
      <div className="mt-20 flex flex-col gap-10">
        ...
        <div>
          <h2 className="text-3xl my-3 font-medium">How many days are you planning for the trip?</h2>
          <Input
